  ...
  <div class="min-h-screen bg-gray-50 p-8">
    <main class="space-y-6">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="col-span-1">
          <TextArea
            id="wateringHoleKeywords"
            name="Watering hole keywords:"
            v-model="wateringHoleKeywords"
          />
        </div>
      ...
      <div class="grid gap-2 bg-white p-3 border border-gray-600 shadow-md rounded-md">
        ...
        <SearchTerm v-for="term in terms" :key="term" :term="term" :clickedTerms="clickedTerms" @click="addClickedTerm" />
      </div>
    </main>
  </div>
</template>
